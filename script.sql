...
CREATE TABLE Role (
                      id_role NUMBER(38) GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
...
CREATE TABLE LienVersLaBandeAnnonce (
                                        id_lien NUMBER(38) GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
                                        lien VARCHAR(255),
                                        film_id NUMBER(38) NOT NULL REFERENCES Film(id_film)
);
...
INSERT INTO ABONNEMENT (forfait, cout, reservation_max_copies, duree_max_jours, code)
VALUES ('Débutant', 5, 1, 10, 'D');

INSERT INTO ABONNEMENT (forfait, cout, reservation_max_copies, duree_max_jours, code)
VALUES ('Intermédiaire', 10, 5, 30, 'I');

INSERT INTO ABONNEMENT (forfait, cout, reservation_max_copies, duree_max_jours, code)
VALUES ('Avancé', 15, 10, 9999999999, 'A');
